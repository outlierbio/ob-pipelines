# DB name (this is NOT the RDS DB instance name in AWS RDS Console but the name of database to be created!)
variable "name" {}

# RDS DB instance name in AWS RDS Console
variable "identifier" {}
...
# DB engine version. E.g. for MySQL it can be '5.5.1' or '5.6.17'
